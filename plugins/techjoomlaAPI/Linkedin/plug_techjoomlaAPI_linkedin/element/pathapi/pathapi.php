				...
				protected function getInput()
				{
					...
					if($this->id=='jform_params_pathapi_linkedin')
						$return	='<div class="instructions">
								Go to <a href="http://techjoomla.com/documentation-for-invitex/configuring-linkedin-api-plugin.html" target="_blank">How to configure Techjoomla-LinkedIn API</a><br />
								</div>';
						return $return;
